  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          {/* Brand orange, sourced from the theme tokens so the ribbon keeps
              matching the site's CTA color in both light and dark mode.
              Applied via `style` rather than the `stop-color` attribute:
              presentation attributes don't resolve var(), CSS properties do. */}
          <stop style={{ stopColor: "var(--color-brand-orange-dark)" }} />
          <stop offset="1" style={{ stopColor: "var(--color-brand-orange)", stopOpacity: 1 }} />
        </linearGradient>
      </defs>
    </svg>
  );
